...
namespace Xocv.WebApi
{
    ...
    /// </summary>
    [DependsOn(typeof(AbpWebApiModule), typeof(AbpWebApiODataModule), typeof(XocvApplicationModule))]
    public class XocvWebApiModule : AbpModule
    {
        ...
        public override void Initialize()
        {
            ...
            Configuration.Modules.AbpWebApi().DynamicApiControllerBuilder
                .ForAll<IApplicationService>(typeof(XocvApplicationModule).Assembly, "app")
                .Build();
        ...
        private void ConfigureSwaggerUi()
        {
            Configuration.Modules.AbpWebApi().HttpConfiguration
                .EnableSwagger(c =>
                {
                    c.SingleApiVersion("v1", "Xocv.WebApi");
                    c.ResolveConflictingActions(apiDescriptions => apiDescriptions.First());
                })
                .EnableSwaggerUi(c =>
                {
                    c.InjectJavaScript(Assembly.GetAssembly(typeof(XocvWebApiModule)), "Xocv.WebApi.Scripts.Swagger-Custom.js");
                });
        }
    }
}
