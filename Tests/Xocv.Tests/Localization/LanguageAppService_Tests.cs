...
using Xocv.Localization;
using Xocv.Localization.Dto;
using Xocv.Migrations.Seed;
using Xocv.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace Xocv.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = XocvConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    XocvConsts.LocalizationSourceName,
                    "Save",
