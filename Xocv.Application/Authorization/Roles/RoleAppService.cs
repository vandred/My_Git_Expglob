...
using Xocv.Authorization.Permissions;
using Xocv.Authorization.Permissions.Dto;
using Xocv.Authorization.Roles.Dto;

namespace Xocv.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : XocvAppServiceBase, IRoleAppService
    {
